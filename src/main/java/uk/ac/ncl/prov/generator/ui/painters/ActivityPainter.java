...
public class ActivityPainter extends NodePainter {

	public ActivityPainter() {}
	...
	public void drawNode(Graphics2D g2D, PresentationNode e) {
		...
		GradientPaint gp = new GradientPaint(0, 0, new Color(236,209,209), 0,
				e.getHeight(), new Color(212,154,154));
